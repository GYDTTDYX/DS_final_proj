...
* Are there any difference between the tags of popular and unpopular games? 

* Are there any relationship between pricing and game popularity? 

* What is the best combination of tags that could possibly leads to a popular game

## data scources

We uses dataset from Kaggle that use steam API to access steam games information. 
